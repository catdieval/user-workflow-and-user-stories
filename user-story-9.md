...
- [ ] In the Plotting component, access the markerColor, markerSymbol and markerSize variables.
  ...
  - [ ] In the second render of Plot replace the value of the data attribute by {[dataOptions]} and in the second conditional expression add barColor.length > 0 as additional condition.
